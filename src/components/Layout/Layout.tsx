  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      ...
      <main className="flex-1 overflow-auto pb-16 md:pb-0">
        ...
        {subTabs.length > 0 && (
          <div className="md:hidden fixed top-0 left-0 right-0 z-30 flex border-b border-gray-200 dark:border-gray-800 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm shadow-sm">
            {subTabs.map((sub) => {
        ...
        <div className={`p-4 md:p-6 max-w-7xl mx-auto ${subTabs.length > 0 ? 'pt-14 md:pt-6' : ''}`}>
          <Outlet />
        </div>
      </main>
